...
class RdForm extends FormBase
{
    ...
    public function buildForm(array $form, FormStateInterface $form_state)
    {
        ...
        $form['principal'] = array(
              "#type" => "number",
              "#title" => $this->t("Monthly Investment Amount"),
              '#required' => true,
              '#default_value' => 500,
              '#min' => 500,
...
/*         $form['quantity'] = array(
    ...
    public function setMessage(array &$form, FormStateInterface $form_state)
    {
        ...
        /*$exponent = 4*$tenure;
        $mid = 1+($rate/(100*4));
        $afterpow = pow($mid, (4*$tenure));
        $amount = $principal * pow($mid, (4*$tenure));*/
        // rd formula
